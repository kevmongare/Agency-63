    ...
    <section id="team" className="bg-[#080808] py-24 section-divider">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-[#FFC107] text-xs font-bold tracking-[0.25em] uppercase mb-4">THE TEAM</p>
            ...
            <div key={member.name} className="group">
              <div className="relative overflow-hidden rounded-lg mb-4 aspect-[3/4]">
                ...
                <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <a
                    href="#"
                    className="w-8 h-8 rounded-full bg-[#FFC107] flex items-center justify-center"
                  >
                    <ExternalLink size={12} className="text-black" />
                  </a>
                </div>
              </div>
              <h3 className="font-display font-bold text-lg text-white group-hover:text-[#FFC107] transition-colors">
                {member.name}
              </h3>
              <p className="text-[#FFC107] text-xs font-semibold tracking-wide uppercase mb-2">
                {member.role}
              </p>
